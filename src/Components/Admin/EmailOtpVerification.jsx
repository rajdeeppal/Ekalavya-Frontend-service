...
const EmailOtpVerification = ({ username }) => {
  ...
  const handleRequestOtp = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:61002/admin/sendOtp', { username });
      setIsOtpSent(true);
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:61002/admin/validateOtp', { username, otp });
