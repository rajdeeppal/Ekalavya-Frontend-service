...
const EmailOtpVerification = ({ username }) => {
  ...
  const handleRequestOtp = async (e) => {
    ...
    try {
      const response = await axios.post('https://3.111.84.98:61002/api/admin/sendOtp', { username });
      setIsOtpSent(true);
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const response = await axios.post('https://3.111.84.98:61002/api/admin/validateOtp', { username, otp });
