...
const PendingRequests = ({ setPendingCount }) => {
  ...
  useEffect(() => {
    ...
    axios.get('https://ec2-13-232-188-255.ap-south-1.compute.amazonaws.com/api/admin/manageRoles', {
      headers:{
  ...
  const handleStatusChange = (requestId, newStatus, approverComments) => {
    axios.post('https://ec2-13-232-188-255.ap-south-1.compute.amazonaws.com/api/admin/approveRoleRequest', {
        requestId,
        approverComments,
      },{
        headers: {
  ...
  const handleRejectRoleRequest = (requestId, approverComments) => {
    axios.post('https://ec2-13-232-188-255.ap-south-1.compute.amazonaws.com/api/admin/rejectRoleRequest', {
        requestId,
        approverComments,
      },{
        headers: {
