...
const PendingRequests = ({ setPendingCount }) => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:61002/admin/manageRoles', {
      headers:{
  ...
  const handleStatusChange = (requestId, newStatus, approverComments) => {
    axios.post('http://localhost:61002/admin/approveRoleRequest', {
        requestId,
        approverComments,
      },{
        headers: {
  ...
  const handleRejectRoleRequest = (requestId, approverComments) => {
    axios.post('http://localhost:61002/admin/rejectRoleRequest', {
        requestId,
        approverComments,
      },{
        headers: {
