...
const PendingRequests = ({ setPendingCount }) => {
  ...
  useEffect(() => {
    ...
    axios.get('http://3.111.84.98:61002/api/admin/manageRoles', {
      headers:{
  ...
  const handleStatusChange = (requestId, newStatus, approverComments) => {
    axios.post('http://3.111.84.98:61002/api/admin/approveRoleRequest', {
        requestId,
        approverComments,
      },{
        headers: {
  ...
  const handleRejectRoleRequest = (requestId, approverComments) => {
    axios.post('http://3.111.84.98:61002/api/admin/rejectRoleRequest', {
        requestId,
        approverComments,
      },{
        headers: {
