...
const PendingRequests = ({ setPendingCount }) => {
  ...
  useEffect(() => {
    ...
    axios.get('http://13.233.255.117:61002/admin/manageRoles', {
      headers:{
  ...
  const handleStatusChange = (requestId, newStatus, approverComments) => {
    axios.post('http://13.233.255.117:61002/admin/approveRoleRequest', {
        requestId,
        approverComments,
      },{
        headers: {
  ...
  const handleRejectRoleRequest = (requestId, approverComments) => {
    axios.post('http://13.233.255.117:61002/admin/rejectRoleRequest', {
        requestId,
        approverComments,
      },{
        headers: {
