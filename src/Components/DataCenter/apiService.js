...
const BASE_URL = "http://3.111.84.98:61002/api/admin"; // Update with your actual API URL http://3.111.84.98:61002/api/admin
const PM_BASE_URL = "http://3.111.84.98:61002/api/user/pm";
const BASE_PUBLIC_URL = "http://3.111.84.98:61002/api/self-service";

const BENEFICIARY_BASE_URL = "http://3.111.84.98:61002/api/beneficiary";
const SUBMIT_BASE_URL = "http://3.111.84.98:61002/api/ops/pm";
...
export const getBeneficiary = async (userId, data, category) => {
    try {
      ...
      let url = `http://3.111.84.98:61002/api/beneficiary/filter/${userId}`;
...
export const updatedResubmitBeneficiarySubTask = async (rowId, object) => {
  try {
    const response = await axios.put(
      `http://3.111.84.98:61002/api/ops/pm/resubmit/${rowId}`,
      object,
      {
        headers: {
          ...getAuthorizationHeader(),
...
export const updatedResubmitSubTask = async (userId,rowId,remarks) => {
  try {
    const response = await axios.post(
      `http://3.111.84.98:61002/api/ops/user/resubmit/${userId}/${rowId}?remarks=${remarks}`,
...
export const getPaymentDetails = async (data, category) => {
  try {
    ...
    // Start building the query parameters
    let url = `http://3.111.84.98:61002/api/ao/payments/pending`;
    const params = new URLSearchParams();
...
export const getUpdatedPaymentDetails = async (data) => {
  try {
    ...
    // Start building the query parameters
    let url = `http://3.111.84.98:61002/api/ao/statement/view`;
    const params = new URLSearchParams();
...
export const getStateDetails = async () => {
    ...
    try {
        const response = await axios.get(`http://3.111.84.98:61002/api/api/states`,{
            headers:getAuthorizationHeader()
          });
...
export const getDistrictDetails = async (state_id) => {
    ...
    try {
        const response = await axios.get(`http://3.111.84.98:61002/api/api/districts/${state_id}`,{
            headers:getAuthorizationHeader()
          });
...
export const domainDetails = async (taskId) => {
  try {
    const response = await axios.get(
      `http://3.111.84.98:61002/api/user/search/domain-expert/${taskId}`,
      {
        headers: getAuthorizationHeader(),
      }
    );
...
export const approveDomainDetails = async (employeeId,taskId,remarks) => {
  try {
    const response = await axios.post(
      `http://3.111.84.98:61002/api/ops/user/approve/${employeeId}/${taskId}?remarks=${remarks}`,
       null, // No request body
            {
              headers: {
                ...getAuthorizationHeader() // Authorization headers
...
export const rejectDomainDetails = async (employeeId,taskId,remarks) => {
  try {
    const response = await axios.post(
      `http://3.111.84.98:61002/api/ops/user/rejection/${employeeId}/${taskId}?remarks=${remarks}`, // URL
      null, // No request body
      {
        headers: {
          ...getAuthorizationHeader() // Authorization headers
...
export const generatedVoucherDetails = async (object) => {
  try {
    const response = await axios.post(
      `http://3.111.84.98:61002/api/ao/voucher/generate`, // URL
...
export const getVoucherDetails = async (voucher_id) => {
  try {
    const response = await axios.get(
      `http://3.111.84.98:61002/api/ao/voucher/search/${voucher_id}`,
      {
        headers: getAuthorizationHeader(),
      }
    );
...
export const getProfileDetails = async (userId) => {
  try {
    const response = await axios.get(
      `http://3.111.84.98:61002/api/user/profile/${userId}`,
      {
        headers: getAuthorizationHeader(),
      }
    );
...
export const generatedPaymentDetails = async (object) => {
  try {
    const response = await axios.post(
      `http://3.111.84.98:61002/api/ao/payments/process`, // URL
      object, // No request body
      {
        headers: getAuthorizationHeader(),
      }
...
export const exportPaymentDetails = async (userId, data) => {
  try {
    ...
    // Start building the query parameters
    let url = `http://3.111.84.98:61002/api/ao/statement/export/${userId}`;
    const params = new URLSearchParams();
...
export const exportCEOPaymentDetails = async (userId, data, componentName) => {
  try {
    ...
    // Start building the query parameters
    let url = `http://3.111.84.98:61002/api/download/payee/excel/${userId}`;
    const params = new URLSearchParams();
...
export const exportBeneficiaryDetails = async (userId, data) => {
  try {
    ...
    // Start building the query parameters
    let url = `http://3.111.84.98:61002/api/reports/beneficiary/${userId}`;
    const params = new URLSearchParams();
...
export const exportComponentDetails = async (userId, data) => {
  try {
    ...
    // Start building the query parameters
    let url = `http://3.111.84.98:61002/api/reports/component/${userId}`;
    const params = new URLSearchParams();
...
export const exportFinalPreviewDetails = async (userId, data) => {
  try {
    ...
    // Start building the query parameters
    let url = `http://3.111.84.98:61002/api/download/beneficiary/excel/${userId}`;
    const params = new URLSearchParams();
