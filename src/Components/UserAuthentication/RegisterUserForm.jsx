...
const RegisterUserForm = () => {
  ...
  useEffect(() => {
    const fetchRoles = async () => {
      try {
        const response = await axios.get('https://3.111.84.98:61002/api/roleAudit');
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post('https://3.111.84.98:61002/api/self-service/submitRoleRequest', JSON.stringify(formData), {
        headers: {
