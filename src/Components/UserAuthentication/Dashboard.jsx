...
const Dashboard = () => {
  ...
  useEffect(() => {
    setLoading(true);
    Promise.all([
      axios.get("http://3.111.113.121:61002/dashboard/project/count"),
      axios.get("http://3.111.113.121:61002/dashboard/beneficiary/count"),
      axios.get("http://3.111.113.121:61002/dashboard/project/progress"),
    ])
