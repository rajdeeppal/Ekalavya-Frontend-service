...
const Dashboard = () => {
  ...
  useEffect(() => {
    setLoading(true);
    Promise.all([
      axios.get("http://3.111.113.121:61002/api/dashboard/project/count"),
      axios.get("http://3.111.113.121:61002/api/dashboard/beneficiary/count"),
      axios.get("http://3.111.113.121:61002/api/dashboard/project/progress"),
    ])
